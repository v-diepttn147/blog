...
I'm not an over-ambitious person but when thinking about building an open-source project, I wanted to build something big, something that could wow people instantly but that wasn't gonna happen in my case. Spending time thinking about big things makes me procrastinated. So I decided to do small things first to get me used to how to build a open source project first.
...
When I presented my project to a community to gather feedbacks. There were some toxic feedbacks, it made me feel discouraged. But my goal is not to make people impressive, what I want are feedbacks. And yeah, I got feedbacks so what I should expect more?
