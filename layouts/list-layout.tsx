          ...
          <div className="relative max-w-lg">
            <label>
              ...
              <input
                ...
                className="block w-full rounded-md border border-gray-300 bg-white px-4 py-2 text-gray-900 focus:border-accent-500 focus:ring-accent-500 dark:border-gray-900 dark:bg-gray-800 dark:text-gray-100"
              />
            </label>
            <svg
